...
import {main} from './app/log-parser/main';
...
const testPath = 'C:\\Users\\Matthis\\AppData\\LocalLow\\Wizards Of The Coast\\MTGA\\output_log.txt';
// const testPath =
//   'C:\\Program Files (x86)\\Wizards of the Coast\\MTGA\\MTGA_Data\\Logs\\Logs\\UTC_Log - 11-28-2019 13.30.21.log';
main(testPath);
